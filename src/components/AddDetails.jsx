      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
        <div className="px-6 py-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Link
              to={`/coach/${coachId}/CoachDashboard`}
              className="mt-6 block text-center"
            >
              <button className="text-indigo-600 hover:text-indigo-500 bg-indigo-100 px-4 py-2 rounded-md transition duration-150 ease-in-out hover:bg-indigo-200">
                Back to Dashboard
              </button>
            </Link>
          </form>
